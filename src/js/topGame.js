import { getAllCategories, getTopGamesByCategory } from './infoFromDB.js';
...
//                 loadGames(category.tags[0], category.games);
//             });
//         })
//         .catch(error =>
//             console.error('Помилка при завантаженні категорій ігор:', error)
//         );
// }
...
const topGames = getTopGamesByCategory(categories);
